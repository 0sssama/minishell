...
#    Updated: 2022/03/04 16:41:37 by obouadel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES= 	src/main utils/exits/ft_free_exit src/ft_prompt src/ft_execute utils/implement/ft_cd \
		...
		utils/parsing/ft_token utils/parsing/ft_parse_tree utils/args/ft_args utils/execution/ft_save_io \
		utils/parsing/ft_check_tokens utils/execution/ft_execution utils/execution/ft_pipe 
OBJS= $(FILES:=.o)
NAME= minishell
INCLUDES=includes
READLINE=-lreadline
