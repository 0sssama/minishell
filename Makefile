...
#    Updated: 2022/03/10 16:38:18 by olabrahm         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES= 	src/main utils/exits/ft_free_exit src/ft_prompt src/ft_execute utils/implement/ft_cd \
		...
		utils/parsing/ft_put_exitcode utils/parsing/ft_wildcard
...
$(NAME): $(LIBFT) $(OBJS) 
	...
	@echo "\033[30;1m---> \033[0mMinishell V1.9 \033[32;1m [OK] \033[0m"
